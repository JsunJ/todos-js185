...
module.exports = class PgPersistence {
  ...
  // Returns a copy of the list of todos in the indicated todo list sorted by
  ...
  // Delete the specified todo list from the list of todo lists. Returns a
  // promise that resolves to `true` on success, `false` if the todo list
  // doesn't exist. The id argument must be numeric.
  ...
  // resolves to `true` on success, `false` if the todo list isn't found. The
  ...
  // Mark all todos on the todo list as done. Returns a promise which resolves
  // to `true` on success, `false` if the todo list doesn't exist.
  ...
  // if the todolist already exists.
