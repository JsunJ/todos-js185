...
module.exports = class SessionPersistence {
  ...
  // Returns a copy of the todo list with indicated ID. Returns `undefined`
  ...
  // Delete the specified todo list from the list of todo lists. Returns `true`
  // on success, `false` if the todo list doesn't exist. The id argument must
  // be numeric.
